...
export default class RichTextEditorModal extends Component {
    constructor(props) {
        super(props);
        this.state = {
            attachedDocuments: []
    ...
    async sendReply(){       
        let reply = {}
        reply.text = await this.richtext.getContentHtml()
            ...
            <Modal
                ...
                <View style={styles.container}>  
                    <View style={styles.content}> 
                        ...
                        <RichTextToolbar
                            iconMap={this.getIcons()}
                            style={{backgroundColor:'#fff'}}
                            selectedButtonStyle={{backgroundColor:'grey'}}
                            unselectedButtonStyle={{backgroundColor:'#fff'}}
