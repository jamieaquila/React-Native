...
const ScrollableTabBar = React.createClass({
  propTypes: {
    ...
    tabsStyle: View.propTypes.style,
  ...
  renderTabOption(name, page) {
    ...
    >
      <View style={[styles.tab, this.props.tabStyle]}>
        <Text style={[textStyle, isTabActive && activeTextStyle]}>
          {name}
        </Text>
      </View>
    </Button>;
  ...
  render() {
    ...
    return  <Animated.View
        style={[styles.container, { backgroundColor: this.props.backgroundColor }, this.props.style, this.props.containerStyle]}
