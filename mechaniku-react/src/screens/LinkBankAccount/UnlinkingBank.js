...
export default class UnlinkingBankScreen extends Component{   
    constructor(props){
        super(props)
        ...
        return (
            <View style={styles.container}> 
                <View style={styles.content}>
                    <Text style={{fontSize:13, color:'rgba(2, 6, 33, 0.6)', textAlign:'center'}} >Bank Account Not Saved!</Text>                                        
                </View>                
                <View style={{paddingTop:92 * Metrics.scaleHeight, alignItems:'center', justifyContent:'center'}}>
                    <Image style={{width:192 * Metrics.scaleHeight, height:143 * Metrics.scaleHeight}} source={Images.bankUnlinkIcon} />
                </View>
                <Text style={{fontSize:16, color:'rgba(2, 6, 33, 0.9)', textAlign:'center', paddingTop:52 * Metrics.scaleHeight}}>You will not be able to receive payouts.</Text>
...
const styles = StyleSheet.create({
    ...
    content:{        
        marginTop: 5 * Metrics.scaleHeight,
        alignItems:'center',
